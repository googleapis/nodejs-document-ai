...
describe('v1.DocumentProcessorServiceClient', () => {
    ...
    describe('fetchProcessorTypes', () => {
        it('invokes fetchProcessorTypes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.FetchProcessorTypesRequest());
            request.parent = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.documentai.v1.FetchProcessorTypesResponse());
    ...
    describe('getProcessor', () => {
        it('invokes getProcessor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.GetProcessorRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.documentai.v1.Processor());
    ...
    describe('getProcessorVersion', () => {
        it('invokes getProcessorVersion without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.documentai.v1.ProcessorVersion());
    ...
    describe('deleteProcessorVersion', () => {
        it('invokes deleteProcessorVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.DeleteProcessorVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deployProcessorVersion', () => {
        it('invokes deployProcessorVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.DeployProcessorVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('undeployProcessorVersion', () => {
        it('invokes undeployProcessorVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.UndeployProcessorVersionRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteProcessor', () => {
        it('invokes deleteProcessor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.DeleteProcessorRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('enableProcessor', () => {
        it('invokes enableProcessor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.EnableProcessorRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('disableProcessor', () => {
        it('invokes disableProcessor without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.DisableProcessorRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('setDefaultProcessorVersion', () => {
        it('invokes setDefaultProcessorVersion without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.SetDefaultProcessorVersionRequest());
            request.processor = '';
    ...
    describe('listProcessorTypes', () => {
        it('invokes listProcessorTypes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.ListProcessorTypesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listProcessors', () => {
        it('invokes listProcessors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.ListProcessorsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('listProcessorVersions', () => {
        it('invokes listProcessorVersions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.documentai.v1.ListProcessorVersionsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
