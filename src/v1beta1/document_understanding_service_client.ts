...
export class DocumentUnderstandingServiceClient {
  ...
  batchProcessDocuments(
      request: protosTypes.google.cloud.documentai.v1beta1.IBatchProcessDocumentsRequest,
      options?: gax.CallOptions):
      Promise<[
        LROperation<protosTypes.google.cloud.documentai.v1beta1.IBatchProcessDocumentsResponse, protosTypes.google.cloud.documentai.v1beta1.IOperationMetadata>,
 ...
 */
  batchProcessDocuments(
    ...
    this.initialize();
    return this._innerApiCalls.batchProcessDocuments(request, options, callback);
  }
